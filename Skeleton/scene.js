...
class Example extends Phaser.Scene {
  ...
  preload() {
    this.load.json(
      "map",
      "https://labs.phaser.io/assets/tests/iso/isometric-grass-and-water.json"
    );
    this.load.spritesheet(
      "tiles",
      "https://labs.phaser.io/assets/tests/iso/isometric-grass-and-water.png",
      { frameWidth: 64, frameHeight: 64 }
    );
    this.load.spritesheet(
      "skeleton",
      "https://labs.phaser.io/assets/tests/iso/skeleton8.png",
      { frameWidth: 128, frameHeight: 128 }
    );
    this.load.image(
      "house",
      "https://labs.phaser.io/assets/tests/iso/rem_0002.png"
    );
  }
